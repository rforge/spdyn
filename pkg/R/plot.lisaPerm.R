...
plot.lisaPerm<-function(lmoran,shape,signif=.05,legend.title='',lty=1,lwd=1,fillBorder='black',box.lwd=1){
...
plot(shape,border="lightgray",col=colors[findInterval(q,brks,all.inside=FALSE)],
     lty=lty,lwd=lwd)
box(lwd=box.lwd)
